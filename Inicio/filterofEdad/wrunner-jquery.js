      ...
      v = (function () {
        function e() {
          !(function (e, t) {
            ...
            (this.$outer = $("<div class='wrunner__outer'>").appendTo(
              this.$base
            )),
            (this.$path = $("<div class='wrunner__path'>").appendTo(
              this.$outer
            )),
            (this.$pathPassed = $("<div class='wrunner__pathPassed'>").appendTo(
              this.$path
            )),
            ...
            (this.$divisions = $("<div class='wrunner__divisions'>").appendTo(
              this.$outer
            )),
            (this.divisionsList = []),
            this._addEvents(),
                  ...
                  .forEach(function (t) {
                    for (var i in e) {
                      var n = t[0].classList[0],
                        s = e[i].oldValue,
                        a = e[i].value;
                      s && t.removeClass(n + "_" + e[i].className + "_" + s),
                        t.addClass(n + "_" + e[i].className + "_" + a);
                    }
                  });
              },
            },
                ...
                if (
                  ...
                  this.$valueNoteMin.text(e.minValue),
                    ...
                    o === l.horizontalValue &&
                      ...
                      this.$valueNoteMin.css(
                        "left",
                        (((n * v) / 100 - r / 2) / n) * 100 + "%"
                      ),
                      this.$valueNoteMax.css(
                        "left",
                        (((n * (v + a)) / 100 - d / 2) / n) * 100 + "%"
                      )),
                    o === l.verticalValue &&
                      ...
                      this.$valueNoteMin.css(
                        "top",
                        100 - (((n * v) / 100 + r / 2) / n) * 100 + "%"
                      ),
                      this.$valueNoteMax.css(
                        "top",
                        100 - (((n * (v + a)) / 100 + d / 2) / n) * 100 + "%"
                      ));
                }
              },
            },
                ...
                if (0 === e.button) {
                  var t = !1,
                    i = function (e) {
                      ...
                      a === o.horizontalValue &&
                        ((t = this.$path.outerWidth()),
                        (i = this.$path[0].getBoundingClientRect().left),
                        (s = e.clientX)),
                        a === o.verticalValue &&
                          ((t = this.$path.outerHeight()),
                          (i = this.$path[0].getBoundingClientRect().top),
                          (s = e.clientY)),
                        (n = i + t),
                        s < i - 10 ||
                          s > n + 10 ||
                    ...
                    n = function (e) {
                      var n = $(e.target);
                      $(document.body).off("mousemove.moveAction", i),
                        t ||
                          n.is(this.$handle) ||
                          n.is(this.$handleMin) ||
                          n.is(this.$handleMax) ||
